...
exports.CreateSystemApplications = asynHandler(async (req, res, next) => {
    /**
 * Create new role.
 ...
 */
    ...
    let results = await GlobalModel.Create(payload, 'applications', '');
...
exports.ViewSystemApplications = asynHandler(async (req, res, next) => {
...
exports.UpdateSystemApplications = asynHandler(async (req, res, next) => {
    let payload = req.body;
    payload.updated_at = systemDate

    const runupdate = await GlobalModel.Update(payload, 'applications', 'application_id', payload.application_id)
